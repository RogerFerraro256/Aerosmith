...
public class RadarObjects extends PApplet {
  ...
  float pixsDistance;
	...
	public void setup() {
		...
		size(1920, 1080);
		smooth();
		myPort = new Serial(this, Serial.list()[0], 9600); // i changed the Serial so this will aways pick my arduino
		myPort.bufferUntil('.'); // this will read itens from the Serial port
	...
	public void drawObject() {
		...
		pixsDistance = iDistance * ((height - height * 0.1666) * 0.025); // covers the distance from the sensor from cm
																			// to pixels
